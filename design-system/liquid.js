...
(function(){
  ...
  let n=0;
  document.querySelectorAll('.t,.pill').forEach(el=>{
    ...
    const isPill=el.classList.contains('pill');const bezel=isPill?18:46,scale=isPill?40:90,blur=isPill?1.2:el.matches(".blue,.navy")?5:3.5;
